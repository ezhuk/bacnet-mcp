...
@pytest.mark.asyncio
async def test_read_object_list(server, mcp, client):
...
async def test_read_property(server, mcp, client, prop, expected):
...
@pytest.mark.asyncio
async def test_who_is(server, mcp, client):
    """Test who_is tool."""
    result = await client.call_tool(
        "who_is",
        {
...
@pytest.mark.asyncio
async def test_who_has(server, mcp, client):
    """Test who_has tool."""
    result = await client.call_tool(
        "who_has",
